...
# ---------------------------------------------------------------------------
LLM_LOCAL_PATH = "C:\\Users\\vimal\\OneDrive\\Documents\\Uni\\BTP\\User-Adaptive-XAI\\Phi-4-mini-instruct"   # <-- set to your local Qwen directory
...
# ---------------------------------------------------------------------------
TASK_MODEL_NAME = "ProsusAI/finbert"
TASK_LABELS = ["positive", "negative", "neutral"]  # finbert label order
...
SAMPLE_SIZE = 10                    # <-- change this (10-50 recommended)
RANDOM_SEED = 42
